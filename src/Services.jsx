...
export const Slider = ({Label, Min, Max, Value, Step, OnChange, SliderColor, Sign}) => {
  return (
    <div className="mb-4">
      <label className="block text-gray-700 font-medium mb-2">{Label}: {Value}<span>{Sign}</span></label>
      <input
            type="range"
            min={Min}
            max={Max}
